...
public class PrimeNumberServlet extends HttpServlet {
	  ...
	  public void doGet(HttpServletRequest request,
		...
		// Số lượng chữ số
		int numPrimes = ServletUtilities.getIntParameter(
				request, "numPrimes", 50);
		// Số lượng số
		int numDigits = ServletUtilities.getIntParameter(
				request, "numDigits", 120);
		
		PrimeList primeList = findPrimeList(
				primeListCollection, numPrimes, numDigits);
		if (primeList == null) {
